...
print(sessionIntra.get_wallet_balance(accountType="CONTRACT")['result']['list'][0]['coin'][0]['equity']+" S")
print(sessionIntra2.get_wallet_balance(accountType="CONTRACT")['result']['list'][0]['coin'][0]['equity']+" S")
print(sessionIntra3.get_wallet_balance(accountType="CONTRACT")['result']['list'][0]['coin'][0]['equity']+" S")
print(sessionClassic.get_wallet_balance(accountType="CONTRACT")['result']['list'][0]['coin'][0]['equity']+" S")
print(sessionClassic2.get_wallet_balance(accountType="CONTRACT")['result']['list'][0]['coin'][0]['equity']+" S")
print(sessionClassic3.get_wallet_balance(accountType="CONTRACT")['result']['list'][0]['coin'][0]['equity']+" S")
print(sessionSwing2.get_wallet_balance(accountType="CONTRACT")['result']['list'][0]['coin'][0]['equity']+" S")
print(sessionSwing3.get_wallet_balance(accountType="CONTRACT")['result']['list'][0]['coin'][0]['equity']+" S")
print(sessionSwing3.get_wallet_balance(accountType="CONTRACT")['result']['list'][0]['coin'][0]['equity']+" S")
